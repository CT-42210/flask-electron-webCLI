...
(function (r, i) {
    ...
    (function () {
        ...
        if (!t() && !n) {
            ...
            $.extend({ Storage: { set: n ? r : i, get: n ? u : a, remove: n ? o : s } });
        }
    })();
        ...
        jQuery.extend({
            timer: {
                ...
                timeParse: function (e) {
                    ...
                    var t = this.regex.exec(e.toString().trim());
                    if (t[2]) {
    ...
    function WorkerCache(e) {
        var t = $.extend({ validation: $.noop, action: $.noop, onCache: $.noop }, e);
    ...
    FormatBuffer.prototype.append = function (e, t, n, r) {
        ...
        this._output_buffer.push({ finalize: n.finalize, index: t, raw: n.raw, newline: n.newline });
    };
    ...
    $.fn.cmd = function (z) {
        ...
        if (is_mobile) {
            B = (function () {
                var t = $('<div class="cmd-editable" contenteditable/>').attr({ autocapitalize: "off", autocorrect: "off", spellcheck: "false", tabindex: x.tabindex }).insertAfter(k);
                t.on("focus", function () {
                    k.enable();
                }).on("blur", function () {
                    k.disable();
            ...
            B = (function () {
                var e = generate_id();
                var t = $("<textarea>").attr({ autocapitalize: "off", spellcheck: "false", id: e, tabindex: x.tabindex }).addClass("cmd-clipboard").appendTo(k);
        ...
        var ee = { SPACEBAR: " ", UP: "ArrowUP", DOWN: "ArrowDown", LEFT: "ArrowLeft", RIGHT: "ArrowRight", DEL: "Delete", MULTIPLY: "*", DIVIDE: "/", SUBTRACT: "-", ADD: "+" };
        function te(e) {
        ...
        function Re(t, e) {
            try {
                ...
                var n = $.extend({}, x, { unixFormattingEscapeBrackets: true, position: S, command: true });
        ...
        function j(e, t) {
            ...
            return $.terminal.format(n, { charWidth: x.charWidth, allowedAttributes: x.allowedAttributes || [] });
        }
        function je(e) {
            ...
            return function () {
                ...
                if (Oe(t)) {
                    ...
                    if (o === 0 && a.length === 1) {
                        ...
                        y.before(C(a[0], W));
                        b(a[1] || "", { length: a.length, position: 0, last: a.length <= 2 });
                        if (a.length > 2) {
                            w(a.slice(2));
                        }
                    } else {
        ...
        $.extend(k, {
            ...
            invoke_key: function (e) {
                ...
                var o = $.Event("keydown", { ctrlKey: r, shiftKey: i, altKey: u, metaKey: a, which: ie[n], key: n });
                ...
                .reduce(function (e, t) {
                    ...
                    if (n) {
                        if (n.len !== t.len) {
                            ...
                            e.pop();
                            return e.concat([{ sum: n.sum + t.len, len: n.len, specs: n.specs.concat(t) }]);
                        }
                    }
    ...
    if (support_copy) {
        text_to_clipboard = function e(t, n) {
            ...
            if (window.navigator && window.navigator.clipboard) {
                ...
                var a = $("<textarea/>").css({ position: "fixed", top: 0, left: 0 }).appendTo("body");
                a.val(n).focus();
                a[0].select();
                document.execCommand("copy");
                a.blur();
    ...
    $.terminal = {
        ...
        iterate_formatting: function z(t, e) {
            ...
            for (var x = 0; x < t.length; x++) {
                ...
                if (s(x)) {
                    ...
                    var O = { last: m(), count: g, index: x - w, formatting: h, length: F, text: v, size: j, space: y, space_count: b };
                    var L = e(O);
                    if (L === false) {
                        break;
                    } else if (L) {
                    ...
                    e({ last: true, count: g + 1, index: x, formatting: h, length: 0, text: v, space: y });
                }
                if (v) {
                    x += f();
                }
        ...
        parse_argument: function e(t, n) {
            ...
            if (i) {
                ...
                return r(t);
            } else if (t.match(/^-?[0-9]+n?$/)) {
                if (t.match(/n$/)) {
                    return BigInt(t.replace(/n$/, ""));
                }
    ...
    (function () {
        ...
        $.terminal.format = function i(e, t) {
            var g = $.extend({}, { linksNoReferrer: false, linksNoFollow: false, allowedAttributes: [], charWidth: undefined, escape: true, anyLinks: false }, t || {});
            var u = l(function (e) {
    ...
    $.jrpc = function (e, t, n, r, i) {
        ...
        function u(e) {
            return typeof e.id === "number" && (typeof e.result !== "undefined" || typeof e.error !== "undefined");
        }
        ids[s.url] = ids[s.url] || 0;
        var l = { jsonrpc: "2.0", method: s.method, params: s.params, id: ++ids[s.url] };
        function f(e, t, n, r) {
    ...
    function get_char_size(e) {
        var t;
        if (terminal_ready(e)) {
            var n = e.find(".cmd-prompt").clone().css({ visiblity: "hidden", position: "absolute" });
    ...
    var signatures = [
        ...
        [
            ...
            "         \\/          /____/                                   ".replace(reg, " ") + version_string,
            copyright,
        ],
        [
            "      __ _____                     ________                            " + "  __",
    ...
    $.fn.terminal = function (e, t) {
        ...
        function M(e, n) {
            ...
            if (is_function(F.renderHandler)) {
                return unpromise(e, function (e) {
                    try {
                        var t = F.renderHandler.call(C, e, n, C);
                        if (t === false) {
                            return false;
                        }
                        if (typeof t === "string" || q(t) || is_promise(t)) {
                            return t;
                        } else {
                            return e;
                        }
        ...
        function J(e) {
            if (is_function(F.onRPCError)) {
                F.onRPCError.call(C, e);
            } else {
                C.error("&#91;RPC&#93; " + e.message);
        ...
        function Q(n, r) {
            ...
            if (F.rpc) {
                i = function () {
                    return F.rpc.apply(C, arguments);
                };
            }
            var u = function (e, t) {
                C.pause(F.softPause);
                $.jrpc({
                    ...
                    success: function e(t) {
                        if (t.error) {
                            ...
                            F.processRPCResponse.call(C, t.result, C);
            ...
            return function (e, t) {
                ...
                if (i === "function") {
                    if (o && r.length !== n.args.length) {
                        C.error("&#91;Arity&#93; " + sprintf(c().wrongArity, n.name, r.length, n.args.length));
                    } else {
                        return r.apply(C, n.args);
                    }
                    ...
                    t.push(r, { prompt: n.name + "> ", name: n.name, completion: i === "object" ? u : undefined });
                } else if (is_function(l)) {
                    l(e, C);
                } else if (is_function(F.onCommandNotFound)) {
                    F.onCommandNotFound.call(C, e, C);
                } else {
        ...
        function V(e, t, n) {
            ...
            if (is_function(F.onAjaxError)) {
                F.onAjaxError.call(C, e, t, n);
            } else if (t !== "abort") {
                C.error("&#91;AJAX&#93; " + t + " - " + c().serverResponse + ":\n" + $.terminal.escape_brackets(e.responseText));
            }
        }
        function G(u, o, r) {
            function s(e) {
                if (e.error) {
                    ...
                    F.processRPCResponse.call(C, e.result, C);
                } else {
                    U(e.result);
                }
                C.resume();
                    ...
                    $.each(n, function (e, i) {
                        if ($.isPlainObject(i) && typeof i.name === "string") {
                            t[i.name] = function () {
                                ...
                                if (F.checkArity && i.params && i.params.length !== n) {
                                    C.error("&#91;Arity&#93; " + sprintf(c().wrongArity, i.name, i.params.length, n));
                                } else {
                                    C.pause(F.softPause);
                                    if (e) {
                                        var r = C.token(true);
                                        if (r) {
                                            ...
                                            C.error("&#91;AUTH&#93; " + c().noTokenError);
                                        }
                                    }
                                    $.jrpc({ url: u, method: i.name, params: t, request: l, response: f, success: s, error: V });
                                }
                            };
                        }
                    });
        ...
        function X(t, a, n) {
            ...
            if (e === "array") {
                ...
                (function t(e, n) {
                    if (e.length) {
                        ...
                        if (u === "string") {
                            ...
                            if (l) {
                                C.error(c().oneInterpreterFunction);
                            } else {
                                l = r;
                            }
                            t(i, n);
                    ...
                    n({ interpreter: Y(o, false, a, l && l.bind(C)), completion: Object.keys(o) });
                });
            } else if (e === "string") {
                if (F.describe === false) {
                    o = { interpreter: Q(t, a) };
                    if (Array.isArray(F.completion)) {
                ...
                n({ interpreter: Y(t, F.checkArity, a), completion: Object.keys(t) });
            } else {
                if (e === "undefined") {
                    t = $.noop;
                } else if (e !== "function") {
        ...
        function te(e, t) {
            return (strlen(text(e)) > t.cols || e.match(/\n/)) && ((F.wrap === true && t.wrap === undefined) || (F.wrap === false && t.wrap === true));
        }
        var f;
        if ("Map" in root) {
            f = new Map();
            ...
            if (r.exec || n.options.clear_exec) {
                return $.terminal.each_extended_command(e, function (e) {
                    if (r.exec) {
                        ...
                        if (g && g === t) {
                            g = "";
                            C.error(c().recursiveLoop);
                        } else {
                            g = t;
                            $.terminal.extended_command(C, e, { invokeMethods: r.invokeMethods }).then(function () {
                                g = "";
                            });
                        }
                    }
        ...
        function re(t) {
            try {
                ...
                var n = $.extend({ exec: true, raw: false, finalize: $.noop, useCache: e, invokeMethods: false, formatters: true, convertLinks: F.convertLinks }, t.options || {});
                var r = vt(t.value);
                ...
                if (r !== "") {
                    if (!n.raw) {
                        if (F.useCache && n.useCache) {
                            ...
                            if (f && f.has(i)) {
                                var u = f.get(i);
                                b.append(u.input, t.index, n, u.raw);
                                return true;
                            }
                        }
                        if (n.formatters) {
                            try {
                                r = $.terminal.apply_formatters(r, $.extend(F, { echo: true }));
                            } catch (e) {
                                D(e, "FORMATTING");
                            }
                        }
                        ...
                        var s = (n.cols = C.cols());
                        if (te(r, n)) {
                            o = $.terminal.split_equal(r, s, { keepWords: n.keepWords, trim: true });
                        } else if (r.match(/\n/)) {
                            o = r.split(/\n/);
                        }
                    }
                ...
                b.append(l, t.index, n, a);
            } catch (e) {
                b.clear();
                if (is_function(F.exceptionHandler)) {
                    F.exceptionHandler.call(C, e, "TERMINAL");
                } else {
        ...
        function i(e) {
            ...
            if (!e.update) {
                B.resize(u);
                var t = _.empty().detach();
            }
            try {
                b.clear();
                unpromise(
                    w.render(C.rows(), function (e) {
                        return e.map(re);
                    }),
                    function () {
                        C.flush(e);
                ...
                if (is_function(F.exceptionHandler)) {
                    F.exceptionHandler.call(C, e, "TERMINAL (redraw)");
                } else {
        ...
        function ue() {
            if (F.greetings === undefined) {
                C.echo(C.signature, { finalize: a11y_hide, formatters: false });
            } else if (F.greetings) {
                ...
                if (e === "string") {
                    ...
                    C.echo(function () {
                        try {
                            var e = new $.Deferred();
                            var t = F.greetings.call(C, e.resolve);
                            if (t) {
                                e.resolve(t);
                            }
                            return e.promise();
        ...
        function oe() {
            return j.outerWidth() !== C.outerWidth();
        }
        function se(e) {
        ...
        function me(n, e, t) {
            ...
            function o(e) {
                return is_function(e.done || e.then) && Ve;
            }
            function s() {
                var e = l.interpreter.call(C, n, C);
                i();
                if (e) {
                    if (!Ue) {
                        if (o(e)) {
            ...
            try {
                ...
                if (t) {
                    g = n.trim();
                    d = $.terminal.split_command(g);
                } else {
                    d = $.terminal.split_command(n);
                }
                if (!Fe()) {
                    if (t && ((is_function(F.historyFilter) && F.historyFilter(n)) || n.match(F.historyFilter))) {
                        B.history().append(n);
                    }
                }
                var l = A.top();
                ...
                var f = new $.Deferred();
                var c = change_hash;
                if (n.match(/^\s*login\s*$/) && C.token(true)) {
                    i();
                    if (C.level() > 1) {
                        C.logout(true);
                    } else {
                    ...
                    u();
                } else if (F.exit && n.match(/^\s*exit\s*$/) && !y) {
                    i();
                    var p = C.level();
                    if ((p === 1 && C.get_token()) || p > 1) {
                        if (C.get_token(true)) {
                            C.set_token(undefined, true);
                        }
                        C.pop();
                    }
                    u();
                } else if (F.clear && n.match(/^\s*clear\s*$/) && !y) {
                    i();
                    C.clear();
                    u();
                } else {
        ...
        function de() {
            var e = C.prefix_name(true) + "_";
            r.remove(e + "token");
            r.remove(e + "login");
        }
        function he(e) {
            var t = C.prefix_name() + "_interpreters";
            var n = r.get(t);
            if (n) {
                n = JSON.parse(n);
            } else {
        ...
        function s(e) {
            var t = A.top();
            var n = C.prefix_name(true);
            if (!Fe()) {
                he(n);
            }
            var r = C.login_name(true);
            B.name(n + (r ? "_" + r : ""));
            var i = t.prompt;
            if (is_function(i)) {
                i = gt(i);
            }
            var u = is_function(t.prompt);
            if (u || i !== B.prompt()) {
                if (u) {
                    B.prompt("");
                }
        ...
        var ve = (function () {
            function e(e) {
                if (!e) {
                    try {
                        C.scroll_to(C.find(".cmd-cursor-line"));
                        return true;
                    } catch (e) {
                        return true;
                    }
        ...
        function ge() {
            var e = C.find(".cmd-cursor-line");
            return e.is_fully_in_viewport(C).then(ve);
        }
        function _e(e) {
        ...
        function Ce() {
            ...
            if (first_instance) {
                ...
                $(window).on("hashchange", ye);
            }
        }
        function Fe() {
            return y || B.mask() !== false;
        }
        function we(e) {
            var t,
                n = A.top();
            if (is_function(n.keydown)) {
                t = n.keydown.call(C, e, C);
                if (t !== undefined) {
                    return t;
                }
            } else if (is_function(F.keydown)) {
                t = F.keydown.call(C, e, C);
                if (t !== undefined) {
                    return t;
                }
            }
        ...
        var Ee = {
            ...
            "CTRL+C": function () {
                with_selection(function (e) {
                    if (e === "") {
                        var t = C.get_command();
                        var n = C.get_position();
                        t = t.slice(0, n) + "^C" + t.slice(n + 2);
                        h(t);
                        C.set_command("");
                    } else {
                        var r = C.find("textarea");
            ...
            TAB: function (e, t) {
                ...
                if (F.completion && get_type(F.completion) !== "boolean" && n.completion === undefined) {
                    r = F.completion;
                } else {
                    r = n.completion;
                }
                ...
                function u(e) {
                    e = e.slice();
                    if (!C.before_cursor(false).match(/\s/)) {
                    ...
                    C.complete(e, { echo: true, word: F.wordAutocomplete, escape: F.completionEscape, caseSensitive: i, echoCommand: F.doubleTabEchoCommand, doubleTab: F.doubleTab });
                }
                if (r) {
                    switch (get_type(r)) {
                        case "function":
                            var a = C.before_cursor(F.wordAutocomplete);
                            if (r.length === 3) {
                            ...
                            for (n = requests.length; n--; ) {
                                ...
                                if (r.readyState !== 4) {
                                    try {
                                        ...
                                        if (is_function(F.exceptionHandler)) {
                                            F.exceptionHandler.call(C, t, "AJAX ABORT");
                                        } else {
                                            C.error(c().ajaxAbortError);
                                        }
                                    }
                                }
                            }
        ...
        function $e(e) {
            var t = A.top();
            if (E && (!k || !F.pauseEvents)) {
                if (is_function(t.keypress)) {
                    return t.keypress.call(C, e, C);
                } else if (is_function(F.keypress)) {
                    return F.keypress.call(C, e, C);
                }
            }
        }
        function ke(y, b) {
            return function e(o, s) {
                var l = $.terminal.apply_formatters(o, { animation: true });
                l = $.terminal.normalize(l);
                var t = false;
                if (s && typeof s.keepWords !== "undefined") {
                    t = s.keepWords;
                }
                if (b) {
                    var n = $.terminal.split_equal(l, C.cols(), { keepWords: t });
                }
                Ve = true;
                var f = C.get_prompt();
                var c = 0;
                var p = $.terminal.length(l);
                if (p > 0) {
                    var m = "";
                    if (s.prompt) {
                        m = s.prompt;
                    ...
                    if (b) {
                        var h = n.map(function (e) {
                            return { formatted: e, chars: $.terminal.partition(e, { wrap: false }), len: $.terminal.length(e) };
                        });
                    } else {
                        var v = $.terminal.partition(l, { wrap: false });
                    }
                    var g;
                    var _ = setInterval(function () {
                        ...
                        if (!Ge) {
                            ...
                            if (c === n && b) {
                                var u = C.last_index();
                                C.set_prompt(f);
                                C.echo(e, $.extend({}, s, { formatters: false, finalize: null, typing: false }));
                                h[d].index = u + 1;
                                m = "";
                                ++d;
                                c = 0;
                            ...
                            C.skip_stop();
                            var a = $.terminal.substring(l, c, p);
                            m += a;
                            B.prompt(m, { formatters: false });
                            g = true;
                        }
        ...
        var Be = (function () {
            ...
            return function (e, t, n) {
                return r(t, $.extend({}, n, { prompt: e + C.get_command() }));
            };
        })();
        var Te = ke(function (e, t, n) {
            C.set_prompt(t);
            C.echo(e, $.extend({}, n, { typing: false }));
        }, true);
        var Se = (function () {
            var r = ke(function (r, e, i) {
                ...
                with_prompt(
                    ...
                    function (e) {
                        ...
                        var n = e + t;
                        i = $.extend({}, i, { typing: false, formatters: false, convertLinks: false });
                        C.echo(n, i);
                    },
                    C
                );
        ...
        function Re(a, o, s) {
            return function e(r, i) {
                var u = new $.Deferred();
                p(function e() {
                    var t = $.extend({ typing: false, delay: F.execAnimationDelay }, i);
                    if (t.typing) {
                        if (typeof r !== "string") {
        ...
        function Oe(u, i, a, o) {
            ...
            function f(e, t, n) {
                ...
                if (t) {
                    ...
                    if (i) {
                        if (!n) {
                            C.error(c().wrongPasswordTryAgain);
                        }
                        C.pop(undefined, true).set_mask(false);
                    } else {
                        y = false;
                        if (!n) {
                            C.error(c().wrongPassword);
                        }
                        C.pop(undefined, true).pop(undefined, true);
                    }
                    r = o;
                }
                if (C.paused()) {
                ...
                C.off("terminal.autologin");
            }
            C.on("terminal.autologin", function (e, t, n, r) {
                je(t, n, function (e) {
                    if (e !== false) {
                        f(t, n, r);
                    }
        ...
        function c() {
            return $.extend({}, $.terminal.defaults.strings, (F && F.strings) || {});
        }
        function ze(e, t) {
        ...
        if (this.length > 1) {
            return this.each(function () {
                $.fn.terminal.call($(this), e, $.extend({ name: C.selector }, t));
            });
        }
        var Pe;
        if (C.is("body,html")) {
            if (C.hasClass("full-screen-terminal")) {
                var Ne = C.find("> .terminal").data("terminal");
                if (Ne) {
                    return Ne;
                }
            }
        ...
        } else if (C.data("terminal")) {
            return C.data("terminal");
        }
        var Me = $.omap(
            {
                id: function () {
                ...
                export_view: function () {
                    var e = v("onExport");
                    e = e || {};
                    return $.extend({}, { focus: E, mask: B.mask(), prompt: C.get_prompt(), command: C.get_command(), position: B.position(), lines: clone(w.data()), interpreters: A.clone(), history: B.history().data }, e);
                },
                import_view: function (t) {
                    ...
                    v("onImport", [t]);
                    p(function e() {
                        C.set_prompt(t.prompt);
                        C.set_command(t.command);
                ...
                save_state: function (e, t, n) {
                    if (typeof n !== "undefined") {
                        save_state[n] = C.export_view();
                    } else {
                        save_state.push(C.export_view());
                    }
                ...
                exec: function (r, i, u) {
                    ...
                    var o = $.extend({ deferred: null, silent: false, typing: false, delay: F.execAnimationDelay }, u);
                    if (i === null) {
                        i = o.silent;
                    }
                    ...
                    l(function e() {
                        if (Array.isArray(r)) {
                            ...
                            var t = o.delay;
                            k = true;
                            var n = C.typing("enter", t, r, { delay: t });
                            n.then(function () {
                                k = false;
                                a(true);
                            });
                ...
                autologin: function (e, t, n) {
                    C.trigger("terminal.autologin", [e, t, n]);
                    return C;
                },
                login: function (t, n, r, i) {
                    Qe.push([].slice.call(arguments));
                    if (y) {
                    ...
                    y = true;
                    if (C.token() && C.level() === 1 && !at) {
                        y = false;
                        C.logout(true);
                    } else {
                        var e = C.token(true);
                        var u = C.login_name(true);
                        if (e && u) {
                            y = false;
                            C.pause();
                            je(u, e, function (e) {
                ...
                complete: function (r, i) {
                    i = $.extend({ word: true, echo: false, escape: true, echoCommand: false, caseSensitive: true, doubleTab: null }, i || {});
                    var u = i.caseSensitive;
                    var a = C.before_cursor(i.word).replace(/\\"/g, '"');
                    var s = false;
                    if (i.word) {
                        if (a.match(/^"/)) {
                            s = '"';
                    ...
                    if (qe % 2 === 0) {
                        Je = C.before_cursor(i.word);
                    } else {
                        var e = C.before_cursor(i.word);
                        if (e !== Je) {
                            return;
                        }
                    }
                    ...
                    function p(e, t) {
                        var n = C.get_command();
                        var r = C.get_position();
                        var i = new RegExp("^" + e, "i");
                        var u = n.slice(0, r);
                        var a = n.slice(r);
                        var o = t.replace(i, "") + (s || "");
                        C.set_command(u + o + a);
                        C.set_position((u + o).length);
                    }
                    if (c.length === 1) {
                        if (i.escape) {
                            p(t, c[0]);
                        } else {
                            C.insert(c[0].replace(f, "") + (s || ""));
                        }
                        Je = C.before_cursor(i.word);
                        return true;
                    } else if (c.length > 1) {
                        if (++qe >= 2) {
                            ...
                            if (i.echo) {
                                if (is_function(i.doubleTab)) {
                                    ...
                                    var m = i.doubleTab.call(C, a, c, h);
                                    ...
                                    C.echo($.terminal.escape_brackets(D), { keepWords: true, formatters: false });
                                }
                                return true;
                            }
                        } else {
                ...
                geometry: function () {
                    const e = Ie();
                    return { terminal: { padding: { left: e.left, right: e.right, top: e.top, bottom: e.bottom }, width: nt + e.left + e.right, height: rt + e.top + e.bottom }, density: O, char: L, cols: this.cols(), rows: this.rows() };
                },
                ...
                resize: function (e, t) {
                    if (!C.is(":visible")) {
                        ...
                        e = C.width();
                        t = C.height();
                        if (typeof F.numChars !== "undefined" || typeof F.numRows !== "undefined") {
                        ...
                        var n = get_num_chars(C, L);
                        var r = get_num_rows(C, L);
                        if (n !== u || r !== Ke) {
                            C.clear_cache();
                            var i = n !== u;
                            u = n;
                ...
                refresh: function () {
                    if (L.width !== 0) {
                        css(C[0], { "--char-width": L.width, "--pixel-density": O });
                    }
                    C.clear_cache();
                    if (Je) {
                        B.resize();
                ...
                flush: function (d) {
                    ...
                    p(function e() {
                        try {
                            ...
                            var t = C.is_bottom();
                            var i = (F.scrollOnEcho && d.scroll) || t;
                            var u;
                            var a = true;
                            var o = false;
                            var s = $();
                            ...
                            b.flush(function (e) {
                                if (!e) {
                                    ...
                                    u.attr("data-index", e.index);
                                    o = !e.newline;
                                    u.toggleClass("partial", o);
                                    if (o) {
                                        s = u;
                                    } else if (e.newline && s.length) {
                                        u = $("<div/>");
                                        s = $();
                                    }
                                    e.finalize(u);
                                    ...
                                    if (o) {
                                        r = u.children().last().append(n);
                                        o = false;
                                    } else {
                                        r = $("<div/>").html(n);
                                        if (e.newline) {
                                            r.addClass("cmd-end-line");
                                        }
                                        u.append(r);
                                    }
                                    r.css("width", "100%");
                            ...
                            if (s.length === 0) {
                                ...
                                n = C.find(".terminal-output div:last-child" + " div:last-child");
                                if (n.css("display") === "inline-block") {
                                    n.css({ width: "100%", display: "" });
                                }
                            } else if (l.length && l[l.length - 1]) {
                                var r = $.terminal.length(l[l.length - 1]);
                                r %= C.cols();
                                n = s.children().last();
                                var f = n[0].getBoundingClientRect();
                                var c = is_ch_unit_supported ? r + "ch" : r + "px";
                                css(B[0], { top: -f.height / O + "px", "--prompt-offset": c });
                                B.__set_prompt_margin(r);
                            }
                            ie();
                            v("onFlush");
                            var p = C.find(".cmd-cursor");
                            var m = C.find(".cmd").offset();
                            var D = C.offset();
                            C.stopTime("flush").oneTime(1, "flush", function () {
                                css(C[0], { "--terminal-height": C.height(), "--terminal-x": m.left - D.left, "--terminal-y": m.top - D.top, "--terminal-scroll": C.prop("scrollTop") });
                                if (E) {
                                    p.hide();
                                    C.oneTime(1, "flush", function () {
                                        p.show();
                                    });
                                }
                            });
                            ...
                            if (is_function(F.exceptionHandler)) {
                                try {
                                    F.exceptionHandler.call(C, e, "TERMINAL (Flush)");
                                } catch (e) {
                        ...
                        if (!w.valid_index(r)) {
                            ...
                            unpromise(t, function (e) {
                                ...
                                unpromise(n, function () {
                                    C.flush({ scroll: false, update: true });
                                });
                            });
                        }
                    });
                ...
                echo: function (e, r, t) {
                    ...
                    function n(i) {
                        try {
                            ...
                            var n = F.externalPause && u.externalPause;
                            (function (t) {
                                if (q(i)) {
                                    return;
                                }
                            ...
                            if (u.typing) {
                                ...
                                var e = C.typing("echo", u.delay, i, u);
                                e.then(function () {
                                    s.resolve();
                                });
                                return;
                            ...
                            unpromise(
                                ...
                                function (e) {
                                    ...
                                    var r = re({ value: e, options: u, index: t });
                                    if (is_promise(r)) {
                                        We = true;
                                    }
                                    w.push([e, u]);
                            ...
                            if (is_function(F.exceptionHandler)) {
                                F.exceptionHandler.call(C, e, "TERMINAL (echo)");
                            } else {
                ...
                exception: function (r, e) {
                    ...
                    if (r.stack) {
                        C.echo(format_stack_trace(r.stack), {
                            finalize: function (e) {
                ...
                logout: function (n) {
                    ...
                    p(function e() {
                        if (n) {
                            ...
                            C.set_token(undefined, true);
                            C.login.apply(C, t);
                        } else if (A.size() === 1 && C.token()) {
                            C.logout(true);
                        } else {
                            while (A.size() > 1) {
                                if (C.token()) {
                                    C.logout(true).pop().pop();
                                } else {
                                    C.pop();
                                }
                            }
                ...
                token: function (e) {
                    return r.get(C.prefix_name(e) + "_token");
                },
                set_token: function (e, t) {
                    var n = C.prefix_name(t) + "_token";
                    if (typeof e === "undefined") {
                        r.remove(n);
                    } else {
                        r.set(n, e);
                ...
                login_name: function (e) {
                    return r.get(C.prefix_name(e) + "_login");
                },
                name: function () {
                    return A.top().name;
                },
                prefix_name: function (e, t) {
                    var n = (F.name ? F.name + "_" : "") + m;
                    if (e && A.size() > 1) {
                ...
                read: function (e, t, n) {
                    ...
                    if (typeof arguments[1] === "object") {
                        r = $.extend({ typing: false, delay: F.execAnimationDelay, success: $.noop, cancel: $.noop }, arguments[1]);
                    } else {
                    ...
                    if (r.typing) {
                        var i = C.get_prompt();
                        r.typing = false;
                        return C.typing("prompt", r.delay, e).then(function () {
                            return C.set_prompt(i).read(e, r);
                        });
                    }
                    Ue = true;
                ...
                push: function (a, o) {
                    l(function e() {
                        ...
                        X(a, o.login, function (e) {
                            A.push($.extend({}, e, r));
                            if (r.completion === true) {
                                if (Array.isArray(e.completion)) {
                            ...
                            if (r.login) {
                                ...
                                if (n === "function") {
                                    t = r.infiniteLogin ? $.noop : C.pop;
                                    C.login(r.login, r.infiniteLogin, u, t);
                                } else if ((get_type(a) === "string" && n === "string") || n === "boolean") {
                                    t = r.infiniteLogin ? $.noop : C.pop;
                                    C.login(Z(a, r.login), r.infiniteLogin, u, t);
                                }
                            } else {
                                u();
                            }
                ...
                destroy: function () {
                    p(function e() {
                        B.destroy().remove();
                        C.resizer("unbind");
                        C.touch_scroll("unbind");
                        lt.resizer("unbind").remove();
                        ft.resizer("unbind").remove();
                        $(document).unbind(".terminal_" + C.id());
                        $(window).unbind(".terminal_" + C.id());
                        C.unbind("click mousedown mouseup");
                        C.removeData("terminal").removeClass("terminal").unbind(".terminal");
                        if (F.width) {
                            C.css("width", "");
                        }
                        if (F.height) {
                        ...
                        $(window).off("blur", ht).off("focus", Dt);
                        C.find(".terminal-fill, .terminal-font, .terminal-font-forcer").remove();
                        C.stopTime();
                        terminals.remove(m);
                        if (T) {
                            if (T.unobserve) {
                        ...
                        var t = C.find(".terminal-scroll-marker");
                        if (et) {
                            et.unobserve(t[0]);
                        }
                        t.remove();
                        ...
                        if (is_mobile) {
                            C.off(["touchstart.terminal", "touchmove.terminal", "touchend.terminal"].join(" "));
                        }
                        _.remove();
                        S.remove();
                        if (Pe) {
                ...
                scroll_to: function (e) {
                    var t = S.scrollTop() - C.offset().top + $(e).offset().top;
                    S.scrollTop(t);
                    return C;
                },
            ...
            function (t, e) {
                return function () {
                    ...
                    try {
                        return e.apply(C, [].slice.apply(arguments));
                    } catch (e) {
                        if (t !== "exec" && t !== "resume") {
        ...
        var Je;
        var Qe = new Stack();
        var Ye = new DelayQueue();
        var Ve = false;
        var Ge = false;
        var Xe = new DelayQueue();
        var p = Le(Xe);
        var l = Le(Ye);
        var Ze;
        var et;
        ...
        var nt, rt;
        var it = [];
        var F = $.extend({}, $.terminal.defaults, { name: C.selector, exit: !!((t && t.login) || !t) }, t || {});
        ...
        delete F.formatters;
        var ut = false;
        var b = new FormatBuffer(function (e) {
            return { linksNoReferrer: F.linksNoReferrer, linksNoFollow: F.linksNoFollow, anyLinks: F.anyLinks, charWidth: L.width, useCache: F.useCache, escape: false, allowedAttributes: e.allowedAttributes || [] };
        });
        var w = new OutputLines(function () {
            return F;
        });
        var r = new n(F.memory);
        var E = F.enabled;
        var x = false;
        var k = false;
        var at = true;
        ...
        $(document).bind("ajaxSend.terminal_" + C.id(), function (e, t) {
            requests.push(t);
        });
        var S = $('<div class="terminal-scroller"/>').appendTo(C);
        var R = $('<div class="terminal-wrapper"/>').appendTo(S);
        $(broken_image).hide().appendTo(R);
        var lt = $('<div class="terminal-font">&nbsp;</div>').appendTo(C);
        var ft = $('<div class="terminal-pixel"/>').appendTo(C);
        var j = $('<div class="terminal-fill"/>').appendTo(S);
        _ = $("<div>").addClass("terminal-output").attr("role", "log").appendTo(R);
        C.addClass("terminal");
        var O = dt();
        var L = get_char_size(C);
        var ct = !terminal_ready(C);
        ...
        if (typeof e === "string") {
            ...
            for (var z = 0, mt = e.length; z < mt; ++z) {
        ...
        if (is_function(F.login)) {
            I = F.login;
        } else if (pt && (typeof F.login === "string" || F.login === true)) {
            I = Z(pt, F.login);
        }
        terminals.append(C);
        function Dt() {
        ...
        function dt() {
            var e = ft[0].getBoundingClientRect();
            return e.width || 1;
        }
        function ht() {
            ot = E;
            C.disable().find(".cmd textarea").trigger("blur", [true]);
        }
        function vt(e) {
            if (is_function(e)) {
                e = e();
            ...
            if (get_type(e) !== "string") {
                if (is_function(F.parseObject)) {
                    ...
                    e = $.terminal.columns(e, C.cols(), F.tabs);
                } else {
                    var n = is_big_int(e);
                    e = String(e);
                    if (n) {
        ...
        $(document).on("paste.terminal_" + C.id(), _t);
        var P = $.extend(
            {},
            Ee,
        ...
        X(e, F.login, function (e) {
            if ((F.completion && typeof F.completion !== "boolean") || !F.completion) {
            ...
            A = new Stack($.extend({}, F.extra, { name: F.name, prompt: t, keypress: F.keypress, keydown: F.keydown, resize: F.onResize, greetings: F.greetings, mousewheel: F.mousewheel, history: F.history, keymap: P }, e));
            B = $("<div/>")
                .appendTo(R)
                .cmd({
                    tabindex: F.tabindex,
            ...
            function n(e) {
                ...
                if (e) {
                    ...
                    if (!$(t).closest(".terminal").length && C.enabled()) {
                        C.disable();
                    }
                }
            }
            C.oneTime(100, function () {
                $(document)
                    .bind("click.terminal_" + C.id(), n)
                    .bind("contextmenu.terminal_" + C.id(), n);
            });
            var r = $(window);
            ...
            if (is_mobile) {
                (function () {
                    ...
                    C.on("touchstart.terminal", function (e) {
                        e = e.originalEvent;
                ...
                r.on("focus.terminal_" + C.id(), Dt).on("blur.terminal_" + C.id(), ht);
                var h;
                (function () {
                    var t = 0;
                    var n;
                    var r = "click_" + C.id();
                    var i = C.find(".cmd textarea");
                    function u() {
                        if (n.is(".terminal") || n.is(".terminal-scroller") || n.is(".terminal-wrapper")) {
                            var e = C.get_command().length;
                            C.set_position(e);
                ...
                (function () {
                    ...
                    C.on(e, function (e) {
                        ...
                        if (h) {
                            ...
                            C.stopTime("textarea");
                            C.oneTime(100, "textarea", function () {
                                var e = { left: "", top: "", width: "", height: "" };
                                if (!is_css_variables_supported) {
                                    var t = C.find(".cmd .cmd-cursor-line").prevUntil(".cmd-prompt").length;
                                    e.top = t * 14 + "px";
                                }
                                D.css(e);
                            });
                            C.stopTime("selection");
                            C.everyTime(20, "selection", function () {
                                if (D[0].selection !== D[0].value) {
                                    if (get_textarea_selection(D[0])) {
                                        clear_textarea_selection(D[0]);
                                        select(C.find(".terminal-output")[0], C.find(".cmd div:last-of-type")[0]);
                                        C.stopTime("selection");
                                    }
                                }
                            });
                ...
                C.on("scroll", function () {
                    var e = C.find("textarea");
                    var t = C[0].getBoundingClientRect();
                    var n = C[0].scrollHeight;
                    var r = S.scrollTop();
                    var i = n - (r + t.height);
                    if (i === 0) {
                        e.css("top", "");
            ...
            function a() {
                ...
                C.resizer("unbind").resizer(u, e);
                lt.resizer("unbind").resizer(function () {
                    i();
                    C.resize();
                }, e);
                ft.resizer("unbind").resizer(function () {
                    O = dt();
                    C.resize();
                }, e);
                $('<div class="terminal-font-forcer terminal-hidden">x<div>').appendTo(C);
            }
            function o(e) {
                Ze = e[0].intersectionRatio >= 0.9;
            }
            function s() {
                if (window.IntersectionObserver) {
                    ...
                    et = new IntersectionObserver(o, { root: S[0], rootMargin: "0px", threshold: 1 });
                    et.observe(t[0]);
                }
            }
            s();
            ...
            function l() {
                ...
                function n() {
                    if (C.is(":visible") && !t) {
                        ...
                        R.css("visibility", "");
                    } else if (t && !C.is(":visible")) {
                        t = false;
                        e = $.terminal.active() === C && C.enabled();
                        C.disable();
                        R.css("visibility", "hidden");
                    }
                }
                if (window.IntersectionObserver && C.css("position") !== "fixed") {
            ...
            if (c) {
                ...
                st.observe(document.body, { childList: true });
            }
            if (f) {
                l();
            }
            ...
            if (E && C.is(":visible") && !is_mobile) {
                C.focus(undefined, true);
            } else {
                C.disable();
            }
            if (is_function(I)) {
                ...
                if (location.hash) {
                    setTimeout(function () {
                        try {
                            ...
                            var n = 0;
                            var r = { typing: F.execAnimation, delay: F.execAnimationDelay };
                            (function e() {
            ...
            (function () {
                var i = false;
                $(document)
                    .bind("keydown.terminal_" + C.id(), function (e) {
                        if (e.shiftKey) {
                            i = true;
                        }
                    })
                    .bind("keyup.terminal_" + C.id(), function (e) {
                ...
                function n(e, t) {
                    if (!i) {
                        ...
                        if (is_function(n.mousewheel)) {
                            r = n.mousewheel(e, t, C);
                        } else if (is_function(F.mousewheel)) {
                            r = F.mousewheel(e, t, C);
                        }
                        if (r === true) {
                            return;
                        }
                ...
                S.touch_scroll(function (e) {
                    ...
                    if (is_function(r.touchscroll)) {
                        n = r.touchscroll(e, t, C);
                    } else if (is_function(F.touchscroll)) {
                        n = F.touchscroll(e, t, C);
                    }
                    css(C[0], { "--terminal-scroll": C.prop("scrollTop") });
                    if (n === true) {
                        return;
                    }
                    return false;
